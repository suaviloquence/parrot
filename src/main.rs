...
fn main() {
	...
	let server = tracker::Server {
		expected_addr: "127.0.0.1:3000".parse().unwrap(),
		// 41b4adfd66d456febbe8f58f6bbc55e5cbfd4592
		info_hash: [
			0x41, 0xb4, 0xad, 0xfd, 0x66, 0xd4, 0x56, 0xfe, 0xbb, 0xe8, 0xf5, 0x8f, 0x6b, 0xbc,
			0x55, 0xe5, 0xcb, 0xfd, 0x45, 0x92,
		],
	};
	dbg!(server.listen()).unwrap();
}
